    ...
    <div v-else class="flex flex-col lg:flex-row h-full">
      ...
      <div class="h-full w-full">
        <div class="grid h-full w-full place-content-center">
          ...
          <h1>
            Status:
            <template v-if="itemSelected.status == 'Available'">
              <h1 class="bg-green-400 text-white rounded-lg font-bold">
                {{ itemSelected.status }}
              </h1>
            </template>
            <template v-else-if="itemSelected.status == 'Claimed'">
              <h1 class="bg-gray-400 text-white rounded-lg font-bold">
                {{ itemSelected.status }}
              </h1>
            </template>
            <template v-else>
